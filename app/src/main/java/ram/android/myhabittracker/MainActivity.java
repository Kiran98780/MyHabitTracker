    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        samplebutton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                EditText sampleNumberSignedEditText = (EditText) findViewById(R.id.numberView);
                String Duration = sampleNumberSignedEditText.getText().toString();
        ...
        Button samplebutton1 = (Button) findViewById(R.id.sample_button1);
